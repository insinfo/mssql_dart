...
void main() async {
  List<String> directories = [
    r'C:\MyDartProjects\mssql_dart\pytds\src\pytds',  
  ];

  String outputFile =
      r'C:\MyDartProjects\mssql_dart\scripts\merged_pytds_code.py.txt';

  try {
    await mergeFiles(directories, outputFile, extensions: ['.py']);
  } catch (e) {
